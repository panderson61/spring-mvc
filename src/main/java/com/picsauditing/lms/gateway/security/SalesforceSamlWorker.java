package com.picsauditing.lms.gateway.security;
...
public class SalesforceSamlWorker {
    ...
    public static String sendSamlRequest(String samlAssertion) {
        ...
        try {
            ...
            builder.addPart("SAMLResponse", new StringBody(samlAssertion, ContentType.MULTIPART_FORM_DATA));
    ...
    public static String sendSamlRequestForApi(String samlAssertion) {
        ...
        try {
            ...
            builder.addPart("assertion", new StringBody(samlAssertion, ContentType.MULTIPART_FORM_DATA));
